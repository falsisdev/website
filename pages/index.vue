<template>
  ...
  <div class="flex-none">
    ...
    <div class="flex flex-wrap flex-row align-items-center justify-center">
     ...
     <div class="align-items-center justify-center w-full mt-5">
        <div class="p-4 rounded-lg">
          <div class="mt-2">
            ...
            <div v-else class="pl-[125px] w-full grid grid-cols-3 md:grid-cols-3 gap-3 mt-6">
      ...
      <div class="align-items-center justify-center w-full mt-5">
        <div class="p-4 rounded-lg">
          <div class="mt-2">
            ...
            <div class="pl-[125px]  w-full grid grid-cols-3 md:grid-cols-3 gap-3 mt-6">
